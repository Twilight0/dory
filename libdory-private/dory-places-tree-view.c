...
#include "dory-places-tree-view.h"

G_DEFINE_TYPE (DoryPlacesTreeView, dory_places_tree_view,
               GTK_TYPE_TREE_VIEW);

static void     dory_places_tree_view_finalize (GObject *gobject);

static gpointer parent_class;

static void
dory_places_tree_view_init (DoryPlacesTreeView *tree_view)
{
    gtk_style_context_add_class (gtk_widget_get_style_context (GTK_WIDGET (tree_view)), "places-treeview");
}

static void
dory_places_tree_view_class_init (DoryPlacesTreeViewClass *klass)
{
	GtkWidgetClass *widget_class = GTK_WIDGET_CLASS (klass);
    GObjectClass         *object_class = G_OBJECT_CLASS(klass);
    parent_class           = g_type_class_peek_parent (klass);
    object_class->finalize = dory_places_tree_view_finalize;
...
GtkWidget *
dory_places_tree_view_new (void)
{
    return g_object_new (DORY_TYPE_PLACES_TREE_VIEW, NULL);
}

static void
dory_places_tree_view_finalize (GObject *object)
{
