...
void
dory_recent_add_file (DoryFile *file,
			  GAppInfo *application)
{
	...
	recent_data.mime_type = dory_file_get_mime_type (file);
	...
	gtk_recent_manager_add_full (dory_recent_get_manager (),
				     uri, &recent_data);
