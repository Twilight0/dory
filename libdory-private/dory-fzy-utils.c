/* dory-fzy-utils.c - Fuzzy matching utilities for Dory
 *
...
/**
 * dory_fzy_strip_combining_marks:
 ...
 */
char *
dory_fzy_strip_combining_marks (const char *str, char **nfkd_out)
{
 ...
 */
PangoAttrList *
dory_fzy_match_attrs (const char *needle, const char *haystack)
{
    ...
    stripped_needle = dory_fzy_strip_combining_marks (needle, NULL);
    stripped_haystack = dory_fzy_strip_combining_marks (haystack, &nfkd);
