...
/*
 * dory-malloc-utils.c - allocator tuning and heap-trim debounce.
 *
...
void
dory_malloc_setup (void)
{
#if HAVE_MALLOPT
    /* Dory mixes lots of small/medium allocations (file lists, icons,
