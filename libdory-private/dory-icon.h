...
#define DORY_ICON_CONTAINER_ICON_DATA(pointer) \
    ((DoryIconData *) (pointer))

typedef struct DoryIconData DoryIconData;

typedef void (* DoryIconCallback) (DoryIconData *icon_data,
