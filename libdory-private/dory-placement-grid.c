...
DoryPlacementGrid *
dory_placement_grid_new (DoryIconContainer *container, gboolean tight)
{
    ...
    grid = g_new0 (DoryPlacementGrid, 1);
...
void
dory_placement_grid_free (DoryPlacementGrid *grid)
{
...
gboolean
dory_placement_grid_position_is_free (DoryPlacementGrid *grid, EelIRect pos)
{
    int x, y;
...
void
dory_placement_grid_mark (DoryPlacementGrid *grid, EelIRect pos)
{
    int x, y;
...
void
dory_placement_grid_canvas_position_to_grid_position (DoryPlacementGrid *grid,
                                                      ...
                                                      EelIRect *grid_position)
{
     ...
     * during a snap. */
    DoryIconContainer *container = grid->container;
...
void
dory_placement_grid_mark_icon (DoryPlacementGrid *grid, DoryIcon *icon)
{
    EelIRect icon_pos;
    EelIRect grid_pos;
    
    dory_icon_container_icon_get_bounding_box (grid->container, icon,
    ...
    dory_placement_grid_mark (grid, grid_pos);
}
