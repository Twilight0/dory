...
/* dory-undo.h - public interface for objects that implement
...
typedef struct _DoryUndoTransaction DoryUndoTransaction;


/* The basic undoable operation. */
typedef void (* DoryUndoCallback) (GObject *target, gpointer callback_data);
...
void dory_undo_register              (GObject              *target,
					  DoryUndoCallback  callback,
					  gpointer              callback_data,
					  GDestroyNotify        callback_data_destroy_notify,
...
void dory_undo_register_full         (GList                *atoms,
					  ...
					  const char           *redo_menu_item_label,
					  const char           *redo_menu_item_hint);
void dory_undo_unregister            (GObject              *target);
 ...
 */
void dory_undo                       (GObject              *undo_manager_search_start_object);

/* Connecting an undo manager. */
void dory_undo_share_undo_manager    (GObject              *destination_object,
