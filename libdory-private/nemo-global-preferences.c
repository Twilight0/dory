...
nemo_global_preferences_init (void)
{
	...
	nemo_preferences = g_settings_new("org.dory.preferences");
	nemo_window_state = g_settings_new("org.dory.window-state");
	nemo_icon_view_preferences = g_settings_new("org.dory.icon-view");
	nemo_list_view_preferences = g_settings_new("org.dory.list-view");
	nemo_compact_view_preferences = g_settings_new("org.dory.compact-view");
	nemo_desktop_preferences = g_settings_new("org.dory.desktop");
	...
	nemo_tree_sidebar_preferences = g_settings_new("org.dory.sidebar-panels.tree");
    nemo_plugin_preferences = g_settings_new("org.dory.plugins");
    nemo_menu_config_preferences = g_settings_new("org.dory.preferences.menu-config");
    nemo_search_preferences = g_settings_new("org.dory.search");
