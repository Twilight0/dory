...
G_DEFINE_TYPE (DoryDBusManager, nemo_dbus_manager, G_TYPE_OBJECT);
...
static void
nemo_dbus_manager_init (DoryDBusManager *self)
{
...
static void
nemo_dbus_manager_class_init (DoryDBusManagerClass *klass)
{
