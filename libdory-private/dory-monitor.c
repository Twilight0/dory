/* -*- Mode: C; indent-tabs-mode: t; c-basic-offset: 8; tab-width: 8 -*-
   ...
   dory-monitor.c: file and directory change monitoring for dory
	     ...
	     gpointer user_data)
{
	...
	case G_FILE_MONITOR_EVENT_CHANGES_DONE_HINT:
		dory_file_changes_queue_file_changed (child);
		break;
	case G_FILE_MONITOR_EVENT_DELETED:
		dory_file_changes_queue_file_removed (child);
		break;
	case G_FILE_MONITOR_EVENT_CREATED:
		dory_file_changes_queue_file_added (child);
		break;
...
DoryMonitor *
dory_monitor_directory (GFile *location)
{
	GFileMonitor *dir_monitor;
	DoryMonitor *ret;

    ret = g_new0 (DoryMonitor, 1);
...
void
dory_monitor_cancel (DoryMonitor *monitor)
{
