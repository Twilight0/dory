...
#include "dory-cell-renderer-disk.h"
#include <math.h>

G_DEFINE_TYPE (DoryCellRendererDisk, dory_cell_renderer_disk,
	       GTK_TYPE_CELL_RENDERER_TEXT);


static void     dory_cell_renderer_disk_get_property  (GObject                    *object,
                                                       guint                       param_id,
                                                       GValue                     *value,
                                                       GParamSpec                 *pspec);

static void     dory_cell_renderer_disk_set_property  (GObject                    *object,
                                                       guint                       param_id,
                                                       const GValue               *value,
                                                       GParamSpec                 *pspec);

static void     dory_cell_renderer_disk_finalize (GObject *gobject);

static void     dory_cell_renderer_disk_render (GtkCellRenderer       *cell,
                                                cairo_t               *cr,
                                                GtkWidget             *widget,
...
static void
dory_cell_renderer_disk_init (DoryCellRendererDisk *cell)
{
	g_object_set (cell,
		      "disk-full-percent", 0,
...
static void
dory_cell_renderer_disk_class_init (DoryCellRendererDiskClass *klass)
{
	GtkCellRendererClass *cell_class = GTK_CELL_RENDERER_CLASS (klass);
    GObjectClass         *object_class = G_OBJECT_CLASS(klass);
    parent_class           = g_type_class_peek_parent (klass);
    object_class->finalize = dory_cell_renderer_disk_finalize;

    object_class->get_property = dory_cell_renderer_disk_get_property;
    object_class->set_property = dory_cell_renderer_disk_set_property;
    cell_class->render = dory_cell_renderer_disk_render;
...
GtkCellRenderer *
dory_cell_renderer_disk_new (void)
{
    return g_object_new (DORY_TYPE_CELL_RENDERER_DISK, NULL);
}

static void
dory_cell_renderer_disk_finalize (GObject *object)
{
    G_OBJECT_CLASS (parent_class)->finalize (object);
}

static void
dory_cell_renderer_disk_get_property (GObject    *object,
                                      guint       param_id,
                                      GValue     *value,
                                      GParamSpec *psec)
{
  DoryCellRendererDisk  *celldisk = DORY_CELL_RENDERER_DISK (object);
...
static void
dory_cell_renderer_disk_set_property (GObject      *object,
                                      guint         param_id,
                                      const GValue *value,
                                      GParamSpec   *pspec)
{
...
static void
dory_cell_renderer_disk_render (GtkCellRenderer       *cell,
                                cairo_t               *cr,
                                GtkWidget             *widget,
                                const GdkRectangle    *background_area,
                                const GdkRectangle    *cell_area,
                                GtkCellRendererState   flags)
{
    DoryCellRendererDisk *cellprogress = DORY_CELL_RENDERER_DISK (cell);
    gint                        x, y, w;
    gint                        xpad, ypad;
    gint                        full;
