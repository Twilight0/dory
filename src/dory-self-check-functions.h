...
/* dory-self-check-functions.h: Wrapper and prototypes for all self
 * check functions in Dory proper.
 */
...
#define DORY_FOR_EACH_SELF_CHECK_FUNCTION(macro) \
/* Add new self-check functions to the list above this line. */

/* Generate prototypes for all the functions. */
DORY_FOR_EACH_SELF_CHECK_FUNCTION (DORY_SELF_CHECK_FUNCTION_PROTOTYPE)
