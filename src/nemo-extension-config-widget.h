...
#define NEMO_TYPE_EXTENSION_CONFIG_WIDGET (dory_extension_config_widget_get_type())

#define DORY_EXTENSION_CONFIG_WIDGET(obj) (G_TYPE_CHECK_INSTANCE_CAST ((obj), NEMO_TYPE_EXTENSION_CONFIG_WIDGET, NemoExtensionConfigWidget))
#define DORY_EXTENSION_CONFIG_WIDGET_CLASS(klass) (G_TYPE_CHECK_CLASS_CAST ((klass), NEMO_TYPE_EXTENSION_CONFIG_WIDGET, NemoExtensionConfigWidgetClass))
...
#define DORY_EXTENSION_CONFIG_WIDGET_GET_CLASS(obj) (G_TYPE_INSTANCE_GET_CLASS ((obj), NEMO_TYPE_EXTENSION_CONFIG_WIDGET, NemoExtensionConfigWidgetClass))
